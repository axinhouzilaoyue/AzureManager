/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 05631f965058140b86af1ad481702b24)
// Runtime types generated with workerd@1.20260301.1 2026-03-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SubscriptionLock";
	}
	interface Env {
		ASSETS: Fetcher;
		APP_NAME: "Azure VM Management Panel";
		SESSION_TTL_SECONDS: 604800;
		LOCK_TIMEOUT_SECONDS: 900;
		AZURE_ARM_BASE_URL: "https://management.azure.com";
		AZURE_AUTH_BASE_URL: "https://login.microsoftonline.com";
		SUBSCRIPTION_LOCK: DurableObjectNamespace<import("./src/index").SubscriptionLock>;
		CREATE_VM_WORKFLOW: Workflow<Parameters<import("./src/index").CreateVmWorkflow['run']>[0]['payload']>;
		VM_LIFECYCLE_WORKFLOW: Workflow<Parameters<import("./src/index").VmLifecycleWorkflow['run']>[0]['payload']>;
		CHANGE_IP_WORKFLOW: Workflow<Parameters<import("./src/index").ChangeIpWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "SESSION_TTL_SECONDS" | "LOCK_TIMEOUT_SECONDS" | "AZURE_ARM_BASE_URL" | "AZURE_AUTH_BASE_URL">> {}
}
